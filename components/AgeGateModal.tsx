  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-2xl max-w-lg w-full mx-4 p-8 text-center transition transform scale-95 animate-fadeIn">
        ...
        <p className="text-gray-600 m-auto  w-3/4  dark:text-gray-300 mb-4">
          I am <strong>over 18 years old</strong> and I accept the viewing of
          explicit texts and images intended for an adult audience.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto text-amber-500 hover:text-amber-600 font-semibold py-2 px-6 rounded-lg border border-amber-500 hover:border-amber-600 transition"
          >
            DECLINE
          </button>
        </div>
