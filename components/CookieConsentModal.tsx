    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-2xl max-w-xl w-full mx-4 p-8 text-center transition transform scale-95 animate-fadeIn">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4">
          We use cookies to optimize the performance of this website and provide
          you with a better user experience in a personalized way.
        </p>
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          For more information, please visit our{" "}
          <a href="/cookie-notice" className="text-amber-500 hover:underline">
            Cookie Notice
          </a>{" "}
          and our{" "}
        ...
        <div className="text-left mb-6">
          <h3 className="font-normal text-sm text-center text-gray-600 dark:text-gray-300 mb-4">
            You can personalise the cookies we use by providing your consent to
            enable their use by us by exercising your choice using the buttons
            below.
          </h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="w-full sm:w-auto bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-lg transition"
          >
            Accept All Cookies
          </button>
          <button
            onClick={handleSave}
            className="w-full sm:w-auto border border-amber-500 hover:border-amber-600 text-amber-500 font-semibold py-2 px-6 rounded-lg transition"
          >
            Save My Preferences
          </button>
          <button
            onClick={handleRejectAll}
            className="w-full sm:w-auto text-gray-500 hover:text-gray-700 font-semibold py-2 px-6 rounded-lg"
          >
